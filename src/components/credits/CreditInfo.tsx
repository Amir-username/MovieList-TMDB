...
function CreditInfo({ credit }: CreditInfoProps) {
  return (
    <div className="flex flex-col p-5 justify-center items-center gap-4">
      ...
      />
      <div className="text-3xl font-semibold text-gray-700">{credit.name}</div>
      ...
      <div className="flex gap-2">
        ...
        <div className="text-lg text-gray-500">{credit.birthday}</div>
      </div>
      <div className="text-lg text-left text-gray-500">{credit.biography}</div>
    </div>
  );
}
